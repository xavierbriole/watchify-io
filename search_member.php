  ...
  <div class="navbar-fixed">
    <nav class="member-nav" role="navigation">
      <div class="nav-wrapper container">
          ...
          <li class="active"><a href="https://www.watchify.io/search.php"><i class="material-icons">search</i></a></li>
    ...
    <div class="section-search">
              ...
              <div class="input-field">
                <i class="material-icons prefix">search</i>
                  <input type="text" name="recherche" id="recherche" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" autofocus="autofocus" placeholder="Search Youtubers" />
                  <!-- <label class="recherche-label" for="recherche">Search Youtubers</label> -->
              </div>
            </div>
